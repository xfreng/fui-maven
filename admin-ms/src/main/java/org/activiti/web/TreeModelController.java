...
@Controller
public class TreeModelController implements ModelDataJsonConstants {
	...
	public void getModelJson(HttpServletRequest request, PrintWriter out) {
		String modelId = request.getParameter("modelId");
		try {
			List<TreeNodeModel> treeNodeModels = getModelNodeByModelId(modelId);
			String json = JSON.encode(treeNodeModels);
			out.write(json);
		} catch (Exception e) {
	...
	@RequestMapping(value = "checkModelByModelId", method = RequestMethod.POST)
	public void checkModelByModelId(HttpServletRequest request, PrintWriter out) {
		String modelId = request.getParameter("modelId");
		try {
