...
public class TokenUtils {
     ...
     * @return
     */
    public ManageToken toManageToken(User user) throws IOException {
        ...
        manageToken.setUploadTime(DateUtils.curDate19());
    ...
    public JSONObject checkManageToken(ManageToken manageToken) {
        ...
        Date userMapTokenTimeToDate = com.baosight.iplat4j.util.DateUtils.toDate(userMapTokenTime, "yyyy-MM-dd HH:mm:ss");
        if ((System.currentTimeMillis() - userMapTokenTimeToDate.getTime()) <= manageTokenTime) {
            if (manageTokenVoFMap.getToken().equals(token)) {
                result.put("status", 1);
                result.put("message", "验证通过");
                manageTokenVoFMap.setUploadTime(DateUtils.curDate19());
     ...
     * @return
     */
    public String generaSecretKey(String userId, String passwordVersion, String key) throws IOException {
     ...
     * @return
     */
    public String generaToken(String userId, String secretKey, String key, String uuid) throws IOException {
