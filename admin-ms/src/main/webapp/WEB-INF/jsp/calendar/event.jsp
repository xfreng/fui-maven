...
<%@page import="com.fui.common.DateUtils"%>
<%@page import="com.fui.common.StringUtils"%>
...
<div class="fancy">
	<h3><%=h3_title %></h3>
    <form id="add_form" action="<%=request.getContextPath() %>/event" method="post">
...
$(function(){
	...
	$("#del_event").click(function(){ 
        if(confirm("您确定要删除吗？")){ 
            ...
            $.post("<%=request.getContextPath() %>/event?action=del",{id:eventid},function(msg){ 
                if(msg==1){//删除成功 
                    $.fancybox.close(); 
