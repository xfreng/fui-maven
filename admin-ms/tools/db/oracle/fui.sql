...
CREATE TABLE FUI_CALENDAR (ID NUMBER(20) NOT NULL, TITLE VARCHAR2(100) NOT NULL, STARTTIME VARCHAR2(20) NOT NULL, ENDTIME VARCHAR2(20) NOT NULL, ALLDAY VARCHAR2(1) NOT NULL, COLOR VARCHAR2(20) NOT NULL, PRIMARY KEY (ID));
