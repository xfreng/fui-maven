...
INSERT INTO `fui_permissions` VALUES (10010101, 100101, 'ED.EDUM', '系统设置', '', '0');
...
INSERT INTO `fui_permissions` VALUES (10020204, 100202, 'RACT01.04', '另存模型', '/supervisor/workflow/model/**/saveas', '1');
INSERT INTO `fui_permissions` VALUES (10020205, 100202, 'RACT01.05', '删除模型（批量）', '/supervisor/workflow/model/deleteModel', '1');
INSERT INTO `fui_permissions` VALUES (10020206, 100202, 'RACT01.06', '复制模型', '/supervisor/workflow/model/copyModel', '1');
INSERT INTO `fui_permissions` VALUES (10020207, 100202, 'RACT01.07', '复制到模型模板', '/supervisor/workflow/model/copyModel2Template', '1');
INSERT INTO `fui_permissions` VALUES (10020208, 100202, 'RACT01.08', '部署流程', '/supervisor/workflow/model/deploy/**', '1');
INSERT INTO `fui_permissions` VALUES (10020209, 100202, 'RACT01.09', '导出模型', '/supervisor/workflow/model/export/**/**', '1');
INSERT INTO `fui_permissions` VALUES (10020210, 100202, 'RACT01.10', '删除模型（单个）', '/supervisor/workflow/model/delete/**', '1');
INSERT INTO `fui_permissions` VALUES (10020211, 100202, 'RACT01.11', '检查模型key值', '/supervisor/checkModelKey', '1');
INSERT INTO `fui_permissions` VALUES (10020212, 100202, 'RACT01.12', '获取模型', '/supervisor/treeModel/getModel', '1');
INSERT INTO `fui_permissions` VALUES (10020213, 100202, 'RACT01.13', '检查模型', '/supervisor/treeModel/checkModelByModelId', '1');
INSERT INTO `fui_permissions` VALUES (10020214, 100202, 'RACT01.14', '设计器首页', '/supervisor/designer/tree-modeler', '1');
INSERT INTO `fui_permissions` VALUES (10020301, 100203, 'RACT02.01', '首页', '/supervisor/workflow/process/index', '1');
INSERT INTO `fui_permissions` VALUES (10020302, 100203, 'RACT02.02', '查询流程定义列表', '/supervisor/workflow/process/list', '1');
INSERT INTO `fui_permissions` VALUES (10020303, 100203, 'RACT02.03', '读取资源（部署ID）', '/supervisor/workflow/process/resource/read', '1');
INSERT INTO `fui_permissions` VALUES (10020304, 100203, 'RACT02.04', '读取资源（流程ID）', '/supervisor/workflow/process/resource/process-instance', '1');
INSERT INTO `fui_permissions` VALUES (10020305, 100203, 'RACT02.05', '删除已部署流程', '/supervisor/workflow/process/delete', '1');
INSERT INTO `fui_permissions` VALUES (10020306, 100203, 'RACT02.06', '输出跟踪流程信息', '/supervisor/workflow/process/trace', '1');
INSERT INTO `fui_permissions` VALUES (10020307, 100203, 'RACT02.07', '读取带跟踪的图片', '/supervisor/workflow/process/trace/auto/**', '1');
INSERT INTO `fui_permissions` VALUES (10020308, 100203, 'RACT02.08', '部署流程', '/supervisor/workflow/process/deploy', '1');
INSERT INTO `fui_permissions` VALUES (10020309, 100203, 'RACT02.09', '启动流程', '/supervisor/workflow/process/start-running/**', '1');
INSERT INTO `fui_permissions` VALUES (10020310, 100203, 'RACT02.10', '转换为模型', '/supervisor/workflow/process/convert-to-model/**', '1');
INSERT INTO `fui_permissions` VALUES (10020311, 100203, 'RACT02.11', '流程状态更改', '/supervisor/workflow/process/processdefinition/update/**/**', '1');
INSERT INTO `fui_permissions` VALUES (10020312, 100203, 'RACT02.12', '导出流程图', '/supervisor/workflow/process/export/diagrams', '1');
INSERT INTO `fui_permissions` VALUES (10020313, 100203, 'RACT02.13', '获取流程定义', '/supervisor/workflow/process/bpmn/model/**', '1');
INSERT INTO `fui_permissions` VALUES (10020401, 100204, 'RACT03.01', '首页', '/supervisor/workflow/processinstance/index', '1');
INSERT INTO `fui_permissions` VALUES (10020402, 100204, 'RACT03.02', '查询运行中的流程', '/supervisor/workflow/processinstance/list', '1');
INSERT INTO `fui_permissions` VALUES (10020403, 100204, 'RACT03.03', '更改运行中流程状态', '/supervisor/workflow/processinstance/update/**/**', '1');
INSERT INTO `fui_permissions` VALUES (100101051, 10010105, 'EDPI00.01', '首页', '/supervisor/project/index', '1');
INSERT INTO `fui_permissions` VALUES (100101052, 10010105, 'EDPI00.02', '查询项目列表', '/supervisor/project/list', '1');
INSERT INTO `fui_permissions` VALUES (100101053, 10010105, 'EDPI00.03', '保存', '/supervisor/project/save', '1');
INSERT INTO `fui_permissions` VALUES (1001010101, 10010101, 'EDUM.EDUM01', '用户管理', '/supervisor/user/index', '0');
INSERT INTO `fui_permissions` VALUES (1001010102, 10010101, 'EDUM.EDUM02', '角色管理', '/supervisor/role/index', '0');
INSERT INTO `fui_permissions` VALUES (1001010103, 10010101, 'EDUM.EDUM03', '权限管理', '/supervisor/right/index', '0');
INSERT INTO `fui_permissions` VALUES (1001010104, 10010101, 'EDUM.EDUM04', '机构管理', '/supervisor/organization/index', '0');
INSERT INTO `fui_permissions` VALUES (1001010105, 10010101, 'EDUM.EDUM05', '日程管理', '', '1');
INSERT INTO `fui_permissions` VALUES (1001010106, 10010101, 'EDUM.EDUM06', '皮肤设置', '/supervisor/style/index', '0');
...
INSERT INTO `fui_permissions` VALUES (10010101014, 1001010101, 'EDUM01.04', '修改', '/supervisor/right/update', '1');
INSERT INTO `fui_permissions` VALUES (10010101015, 1001010101, 'EDUM01.05', '获取角色列表', '/supervisor/right/roleList', '1');
INSERT INTO `fui_permissions` VALUES (10010101016, 1001010101, 'EDUM01.06', '重置密码', '/supervisor/right/resetPwd', '1');
INSERT INTO `fui_permissions` VALUES (10010101017, 1001010101, 'EDUM01.07', '修改状态', '/supervisor/right/status', '1');
INSERT INTO `fui_permissions` VALUES (10010101018, 1001010101, 'EDUM01.08', '修改密码', '/supervisor/right/updatePwd', '1');
INSERT INTO `fui_permissions` VALUES (10010101021, 1001010102, 'EDUM02.01', '首页', '/supervisor/role/index,/supervisor/role/state', '1');
INSERT INTO `fui_permissions` VALUES (10010101022, 1001010102, 'EDUM02.02', '查询角色列表', '/supervisor/role/list', '1');
INSERT INTO `fui_permissions` VALUES (10010101023, 1001010102, 'EDUM02.03', '展示角色树型结构', '/supervisor/right/showRights', '1');
INSERT INTO `fui_permissions` VALUES (10010101024, 1001010102, 'EDUM02.04', '新增', '/supervisor/right/add', '1');
INSERT INTO `fui_permissions` VALUES (10010101025, 1001010102, 'EDUM02.05', '修改', '/supervisor/right/update', '1');
INSERT INTO `fui_permissions` VALUES (10010101031, 1001010103, 'EDUM03.01', '首页', '/supervisor/right/index,/supervisor/right/state', '1');
INSERT INTO `fui_permissions` VALUES (10010101032, 1001010103, 'EDUM03.02', '查询权限列表', '/supervisor/right/list', '1');
INSERT INTO `fui_permissions` VALUES (10010101033, 1001010103, 'EDUM03.03', '选择权限', '/supervisor/right/selectTreeWindow', '1');
INSERT INTO `fui_permissions` VALUES (10010101034, 1001010103, 'EDUM03.04', '展示权限树型结构', '/supervisor/right/selectByKey', '1');
INSERT INTO `fui_permissions` VALUES (10010101035, 1001010103, 'EDUM03.05', '新增', '/supervisor/right/add', '1');
INSERT INTO `fui_permissions` VALUES (10010101036, 1001010103, 'EDUM03.06', '修改', '/supervisor/right/update', '1');
INSERT INTO `fui_permissions` VALUES (10010101041, 1001010104, 'EDUM04.01', '首页', '/supervisor/organization/index,/supervisor/organization/state', '1');
INSERT INTO `fui_permissions` VALUES (10010101042, 1001010104, 'EDUM04.02', '选择人员', '/supervisor/organization/selectUserWindow', '1');
INSERT INTO `fui_permissions` VALUES (10010101043, 1001010104, 'EDUM04.03', '查询机构信息', '/supervisor/organization/selectByPrimaryKey', '1');
INSERT INTO `fui_permissions` VALUES (10010101044, 1001010104, 'EDUM04.04', '展示机构树型结构', '/supervisor/organization/selectByKey', '1');
INSERT INTO `fui_permissions` VALUES (10010101045, 1001010104, 'EDUM04.05', '新增', '/supervisor/organization/add', '1');
INSERT INTO `fui_permissions` VALUES (10010101046, 1001010104, 'EDUM04.06', '修改', '/supervisor/organization/update', '1');
INSERT INTO `fui_permissions` VALUES (10010101047, 1001010104, 'EDUM04.07', '删除', '/supervisor/organization/delete', '1');
INSERT INTO `fui_permissions` VALUES (10010101051, 1001010105, 'EDUM05.01', '首页', '/supervisor/calendar', '1');
INSERT INTO `fui_permissions` VALUES (10010101052, 1001010105, 'EDUM05.02', '事件监听', '/supervisor/eventopt', '1');
INSERT INTO `fui_permissions` VALUES (10010101053, 1001010105, 'EDUM05.03', '获取日历数据', '/supervisor/getCalendarJsonData', '1');
INSERT INTO `fui_permissions` VALUES (10010101054, 1001010105, 'EDUM05.04', '事件操作', '/supervisor/event', '1');
INSERT INTO `fui_permissions` VALUES (10010101061, 1001010106, 'EDUM06.01', '改变皮肤', '/supervisor/style/updateMenuTypeAndStyle', '1');
INSERT INTO `fui_permissions` VALUES (10010103011, 1001010301, 'EDPI10.01', '首页', '/supervisor/menu/index,/supervisor/menu/state', '1');
INSERT INTO `fui_permissions` VALUES (10010103012, 1001010301, 'EDPI10.02', '展示菜单树型结构', '/supervisor/menu/loadMenuNodes', '1');
INSERT INTO `fui_permissions` VALUES (10010103013, 1001010301, 'EDPI10.03', '查询菜单列表', '/supervisor/menu/loadMenuNodePage', '1');
INSERT INTO `fui_permissions` VALUES (10010103014, 1001010301, 'EDPI10.04', '展示Outlook菜单', '/supervisor/menu/loadOutlookTreeNodes', '1');
INSERT INTO `fui_permissions` VALUES (10010103015, 1001010301, 'EDPI10.05', '保存', '/supervisor/menu/saveMenu', '1');
INSERT INTO `fui_permissions` VALUES (10010103016, 1001010301, 'EDPI10.06', '删除', '/supervisor/menu/deleteMenu', '1');
INSERT INTO `fui_permissions` VALUES (10010103017, 1001010301, 'EDPI10.07', '修改', '/supervisor/menu/updateMenu', '1');
INSERT INTO `fui_permissions` VALUES (10010104011, 1001010401, 'EDCM00.01', '首页', '/supervisor/dict/index,/supervisor/dict/dictManager,/supervisor/dict/dictImportManager', '1');
INSERT INTO `fui_permissions` VALUES (10010104012, 1001010401, 'EDCM00.02', '展示字典树型结构', '/supervisor/dict/queryDictForTree', '1');
INSERT INTO `fui_permissions` VALUES (10010104013, 1001010401, 'EDCM00.03', '查询字典类型', '/supervisor/dict/queryDictType', '1');
INSERT INTO `fui_permissions` VALUES (10010104014, 1001010401, 'EDCM00.04', '保存字典类型', '/supervisor/dict/saveDictType', '1');
INSERT INTO `fui_permissions` VALUES (10010104015, 1001010401, 'EDCM00.05', '保存字典详细', '/supervisor/dict/saveDictEntry', '1');
INSERT INTO `fui_permissions` VALUES (10010104016, 1001010401, 'EDCM00.06', '获取字典详细列表', '/supervisor/dict/getLayout', '1');
INSERT INTO `fui_permissions` VALUES (10010104017, 1001010401, 'EDCM00.07', '获取字典', '/supervisor/dict/getDictData', '1');
INSERT INTO `fui_permissions` VALUES (100201010101, 1002010101, '100201010101.01', '启动请假流程', '/supervisor/oa/leave/start', '1');
INSERT INTO `fui_permissions` VALUES (100201010201, 1002010102, '100201010201.01', '签收任务', '/supervisor/oa/leave/task/claim/**', '1');
INSERT INTO `fui_permissions` VALUES (100201010202, 1002010102, '100201010202.02', '读取详细数据', '/supervisor/oa/leave/detail/**', '1');
INSERT INTO `fui_permissions` VALUES (100201010203, 1002010102, '100201010203.03', '读取详细数据(带流程变量)', '/supervisor/oa/leave/detail-with-vars/**/**', '1');
INSERT INTO `fui_permissions` VALUES (100201010204, 1002010102, '100201010204.04', '完成任务', '/supervisor/oa/leave/task/complete/**', '1');
